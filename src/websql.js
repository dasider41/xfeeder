...
const initateTables = db => {
  db.transaction(tx => {
    const queries = [
      "CREATE TABLE IF NOT EXISTS articles (id INTEGER PRIMARY KEY ASC, title TEXT, id INTEGER PRIMARY KEY ASC, title TEXT, link TEXT, date TEXT, date TEXT)",
...
export { dbConn, initateTables, insertMap, showTable };
